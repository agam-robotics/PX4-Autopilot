...
- [Developer Kits](dev_kits/index.md)
  - [ModalAI Starling 2](complete_vehicles_mc/modalai_starling.md)
  - [DroneBlocks DEXI 5](complete_vehicles_mc/droneblocks_dexi.md)
  - [Holybro X500 v2](frames_multicopter/holybro_x500v2_pixhawk6c.md)
...
- [Hardware Selection & Setup](hardware/drone_parts.md)
  ...
  - [Sensors](sensor/index.md)
    ...
    - [RTK GNSS](gps_compass/rtk_gps.md)
      ...
      - [✘ CubePilot Here+](gps_compass/rtk_gps_hex_hereplus.md)
...
- [Development](development/development.md)
  ...
  - [Hardware](hardware/index.md)
    ...
    - [Manufacturers](hardware/manufacturers.md)
      - [Manufacturer’s Board Support Guide](hardware/board_support_guide.md)
      - [Official PX4 Developer Kit Program](hardware/dev_kit_program.md)
  ...
  - [Middleware](middleware/index.md)
    ...
    - [uORB Message Reference](msg_docs/index.md)
      - [Versioned](msg_docs/versioned_messages.md)
        ...
        - [SetpointConfig](msg_docs/SetpointConfig.md)
        - [SetpointConfigReply](msg_docs/SetpointConfigReply.md)
  ...
  - [Platform Testing and CI](test_and_ci/index.md)
    - [Test Flights](test_and_ci/test_flights.md)
      - [Multicopter](test_and_ci/test_flights.md#multicopter)
        ...
        - [Test MC_11 - Companion Computer (ROS 2 External Mode)](test_cards/mc_11_companion_ros2_external_mode.md)
